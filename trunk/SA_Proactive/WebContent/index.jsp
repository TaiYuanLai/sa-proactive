	...
	<div class="indexbg">
		...
		<div class="pageContainer clearfix">
			...
			<div class="rightColumn">
				...
				<!-- 中央處理器 cpu -->
				<%
					List<ProductBean> topCPU = new ArrayList<ProductBean>();
					String cpu="中央處理器";
					topCPU=productDB.getRank(cpu);
				%>
						...
						<div class="product">
							<a href="">
								...
								<div class="productname">
									<span>NO1.</span>
									<p><%=topCPU.get(0).getProductName()%></p>
								</div>
							</a>
						</div>
					</div>
					<div class="col-sm-6 col-md-3">
						<div class="product">
							<a href="">
								...
								<div class="productname">
									<span>NO2.</span>
									<p><%=topCPU.get(1).getProductName()%></p>
								</div>
							</a>
						</div>
					</div>
					<div class="col-sm-6 col-md-3">
						<div class="product">
							<a href="">
								...
								<div class="productname">
									<span>NO3.</span>
									<p><%=topCPU.get(2).getProductName()%></p>
								</div>
							</a>
						</div>
					</div>
