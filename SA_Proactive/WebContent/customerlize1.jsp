				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12 cusstep">
								<div class="cus_step">
									<span class="cus_step_1">Step1 選擇CPU廠牌 / </span> <span>Step2
										選擇CPU型號 / </span> <span>Step3 選擇其他組裝零件</span>
								</div>
							</div>
							<div class="col-md-12">
								<div class="row">
					...
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-12 cusstep">
								<div class="cus_step">
									<span>Step1 選擇CPU廠牌 / </span> <span class="cus_step_1">Step2
										選擇CPU型號 / </span> <span>Step3 選擇其他組裝零件</span>
								</div>
							</div>
							<div class="col-md-12 cpu_select">
								<span>中央處理器</span> <select id="intel" name="intel">
