		...
		<div class="login_div">
			<form class="form-horizontal" role="form" action="" method="">
				...
				<div class="form-group form-group_reg2">
					<p class="p_reg2"><font color="black"> 恭喜您帳號已成功啟用!<br> 我們將提供最完善的電腦客製化組裝服務。<br> Proactive歡迎您!<br><br><br></font> 
					<span class="span_reg3"><font color="red"><三秒後系統將自動跳轉></font></span> </p>
				</div>
			</form>
		</div>
		<div class="container">
